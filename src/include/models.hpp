...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(53, 53, "end", "model_logistic");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        validate_non_negative_index("r_1", "N_1", N_1);
        ...
        validate_non_negative_index("r_2", "N_2", N_2);
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(49, 49, "end", "model_poisson");
    return reader;
}
